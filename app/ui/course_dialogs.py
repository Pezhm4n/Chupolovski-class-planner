...
class EditCourseDialog(QtWidgets.QDialog):
    ...
    def __init__(self, course_data, parent=None):
        ...
        self.name_edit = QtWidgets.QLineEdit(str(course_data.get('name', '') or ''))
        self.code_edit = QtWidgets.QLineEdit(str(course_data.get('code', '') or ''))
        self.instructor_edit = QtWidgets.QLineEdit(str(course_data.get('instructor', '') or ''))
        self.location_edit = QtWidgets.QLineEdit(str(course_data.get('location', '') or ''))
        self.capacity_edit = QtWidgets.QLineEdit(str(course_data.get('capacity', '') if course_data.get('capacity') is not None else ''))
        self.description_edit = QtWidgets.QTextEdit()
        self.description_edit.setPlainText(str(course_data.get('description', '') or ''))
        self.description_edit.setMaximumHeight(80)
        self.exam_time_edit = QtWidgets.QLineEdit(str(course_data.get('exam_time', '') or ''))
        self.credits_spin = QtWidgets.QSpinBox()
        self.credits_spin.setRange(0, 10)
